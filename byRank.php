<!-- <html>
<head>
<title>Top 100 Albums of All Time, Ordered By Rank</title>
	<meta name = "description" content = "A list of the top 100 albums of all time - according to Rolling Stone - ordered by rank. " />
	<style>
		h1 {
			font-family: impact;
			font-weight: normal;
